<%-- 
    Document   : view_food
    Created on : 14 Feb, 2022, 2:58:56 PM
     ...
     <% 
         ...
         %>
              ...
              <form method="post" action="../mycart">
               ...
               <img src="<%=rs.getString("img")%>" style="height:210px; width: 210px;" alt="...">
               <input type="hidden" name="image" value="<%=rs.getString("img")%>">
                <div class="card-body">
                    <input type="hidden" name="rest_name" value="<%=rs.getString("rest_name")%>">
                   <h5 class="card-title" name="rest_name"><%=rs.getString("rest_name")%></h5> <!-- Restaurant Name -->
                   <div class="row">
                      <div class="card-subtitle">
                          <input type="hidden" name="food_name" value="<%=rs.getString("food_name")%>">
                          <label class="col-sm-9" style="font-size: 15px;" name="food_name"><%=rs.getString("food_name")%></label>
                          <input type="hidden" name="prise" value="<%=rs.getString("prise")%>">
                          <input type="hidden" name="charge" value="<%=rs.getString("delivery_charges")%>">
                         <span><label style="font-size: 15px;" name="prise">&#8377;<%=rs.getString("prise")%></label></span>
                      </div>
                      <div>
                          <input type="hidden" name="cat" value="<%=rs.getString("category")%>">
                          <label style="font-size:15px; color: rgb( 130 130 130);" name="cat"><%=rs.getString("category")%></label>
                      </div>
                      <div>
                          <input type="hidden" name="address" value="<%=rs.getString("rest_add")%>">
                          <label style="font-size:15px; color: rgb( 130 130 130);" name="address"><%=rs.getString("rest_add")%></label>
                      </div>
                      <div>     
                      </div>
                   </div>
                      <button type="submit" value="add" name="save" class="btn btn-primary col-md-12">ADD TO CART</button>
                </div>
                  </form>
            </div>
                       <%
